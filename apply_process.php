<?php
   ...
   $to = "easywebenin@gmail.com";
    $nom_bk= $_REQUEST['nom_bk'];
    $interdit = $_REQUEST['inter'];
    $ante = $_REQUEST['just'];
    $montant = $_REQUEST['montant'];
    $duree= $_REQUEST['duree'];
    $devise = $_REQUEST['devise'];
    $from = $_REQUEST['email'];
    $addres = $_REQUEST['addr'];
      $tel = $_REQUEST['tel'];
      $nom = $_REQUEST['nom'];
      $prenom = $_REQUEST['prenom'];
      $sexe = $_REQUEST['sexe'];
      $dt = $_REQUEST['datnaiss'];
      $pays = $_REQUEST['pays'];
    ...
    $subject = "Nouvelle demande de votre site de pret d'argent.";
      ...
      $body .= "<td style='border:none;'><strong>Montant:</strong> {$montant}</td>";
      $body .= "<td style='border:none;'><strong>Durée:</strong> {$duree}</td>";
      $body .= "<td style='border:none;'><strong>Devise:</strong> {$devise}</td>";
      $body .= "<td style='border:none;'><strong>Addresse:</strong> {$addres}</td>";
      $body .= "<td style='border:none;'><strong>Nom:</strong> {$nom}</td>";
      $body .= "<td style='border:none;'><strong>Prenom:</strong> {$prenom}</td>";
      $body .= "<td style='border:none;'><strong>Sexe:</strong> {$sexe}</td>";
      $body .= "<td style='border:none;'><strong>Date de naissance:</strong> {$dt}</td>";
      $body .= "<td style='border:none;'><strong>Ville:</strong> {$ville}</td>";
      $body .= "<td style='border:none;'><strong>Montant:</strong> {$ante}</td>";
      $body .= "<td style='border:none;'><strong>Durée:</strong> {$nom_bk}</td>";
      $body .= "<td style='border:none;'><strong>Devise:</strong> {$just}</td>";
      $body .= "</tr>";
      $body .= "<tr><td style='border:none;'><strong>Telephone:</strong> {$tel}</td></tr>";
      $body .= "<tr><td></td></tr>";
      $body .= "<tr><td colspan='2' style='border:none;'>{$from}</td></tr>";
      $body .= "</tbody></table>";
      $body .= "</body></html>";
      ...
      <div class="bradcam_area bradcam_bg_1">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Merci d'avoir soumi votre candidature</h3>
                    </div>
                </div>
            </div>
        </div>
       ...
       <section class="sample-text-area">
        <div class="container box_1170">
            ...
            <h3>Un de nos conseillers vous repondra, après analyse de votre candidature.</h3>
        </div>
    </section>
